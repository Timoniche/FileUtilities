...
void substring_finder::process_impl(std::string const &pattern,
                                    std::set<FilesTrigram, FilesTrigram::cmp> const *files_trigrams) {
    try {
...
void
substring_finder::process(std::string const &pattern, std::set<FilesTrigram, FilesTrigram::cmp> const *files_trigrams) {
    try {
